      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                      ...
                      <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                        <div>
                          <div className="flex justify-between">
                            <h3 className="text-sm">
                              <a href={`/product/${item.id_inventory}`} className="font-medium text-gray-700 hover:text-gray-800">
                                {item.product_name}
                              </a>
                            </h3>
                          </div>
                        ...
                        <div className="mt-4 sm:mt-0 sm:pr-9">
                          <div class="flex items-center">
                            ...
                            <div class="flex-none"> {item.product_qty}</div>
                          ...
                          <div className="absolute top-0 right-0">
                            <button type="button" className="-m-2 inline-flex p-2 text-gray-400 hover:text-gray-500" onClick={() => deleteItem(item.id)}>
            ...
            <CheckoutInformation carts={carts} />
          </form>
        </div>
        <Toaster/>
      </div>

...
const ResendEmailResetPW = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await api.post("users/resend-forgot-password", {email: email});
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      ...
      <div className="flex flex-col bg-white shadow-md mt-8 px-4 sm:px-6 md:px-8 lg:px-10 py-5 rounded-3xl w-2/3 sm:w-3/4 md:w-2/3 lg:w-1/2 max-w-lg">
        <div className="font-medium self-center text-base text-gray-800">Haven't received a reset password link on your email yet?</div>
        <div className="mt-5">
          <form autoComplete="off">
            ...
            <div className="flex w-full mt-10">
              ...
              >
                {isLoading ? "Loading..." : "Resend Password Reset Link"}
              </button>
              <Toaster />
            </div>
          </form>
...
export default ResendEmailResetPW;

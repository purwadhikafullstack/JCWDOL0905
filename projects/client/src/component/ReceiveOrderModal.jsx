...
export default function ReceiveOrderModal(props) {
  ...
  const receiveOrder = async(id) => {
    try{
      const response = await api.patch(`order/receive/${id}`)
  ...
  return (
    <>  <div className='mb-5'><p>Already received?</p></div>
        <button
        type="button"
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to confirm receive your order?
                        </p>
                      </div>
                    </div>
                  </div>

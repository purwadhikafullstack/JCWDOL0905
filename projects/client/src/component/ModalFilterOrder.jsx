...
export default function ModalFilterOrder() {
  ...
  return (
    <>
      ...
      className="whitespace-nowrap rounded-md border border-transparent bg-green-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 flex items-center"
      >
          Filter & Sort
      </button>
                    ...
                    <div className="mt-3 text-start sm:mt-5">
                      ...
                      <div className="mt-2 flex w-full">
                        <div className='w-full mr-1'>
                            <label
                            htmlFor="start"
                            className="block text-sm font-medium text-warm-gray-900 w-full"
                            >
                            Start Date
                            </label>
                            <div className="mt-1">
                    ...
                    <div className="mt-5 text-start sm:mt-7">
                      ...
                      <div className="mt-2">
                        <div className="relative flex">
                          <div className="flex">
                              ...
                              onChange={() => setDateCheck(document.getElementById("datecheck").checked)}
                              className="h-5 w-5 rounded border-gray-500 text-green-600 focus:ring-green-500"
                              />
                              <div className='ml-3'>
                                <label
                                htmlFor="date"
                      ...
                      <div className="relative flex mt-5">
                          <div className="flex">
                              ...
                              name="pricecheck"
                              type="checkbox"
                              defaultChecked={priceCheck}
                              onChange={() => setPriceCheck(document.getElementById("pricecheck").checked)}
                              className="h-5 w-5 rounded border-gray-500 text-green-600 focus:ring-green-500"
                              />
                              <div className='ml-3'>
                                <label

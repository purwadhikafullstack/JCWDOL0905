...
export default function EditProductModal({ open, setOpen, onClose, product, categories}) {
                                  ...
                                  <Field name="product_name">
                                    {({ field, form }) => (
                                      <div>
                                        ...
                                        <div className="my-2">
                                          <input
                                            {...field} id="product_name" type="text" className={`block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6 ${
                                  ...
                                  <Field name="id_category">
                                    {({ field, form }) => (
                                      <div>
                                        ...
                                        <div className="my-2">
                                          <select
                                            {...field} id="id_category" required className={`w-full rounded-md border border-gray-200 text-md focus:ring-2 focus:ring-inset focus:ring-green-600 active:border-green-500 hover:border-green-500 target:border-green-500 ${
                                  ...
                                  <Field name="product_description">
                                    {({ field, form }) => (
                                      <div>
                                        ...
                                        <div className="my-2">
                                          <textarea
                                            {...field} id="product_description" type="text" className={`block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6 ${
                                    ...
                                    {({ field, form }) => (
                                      <div className="ml-4">
                                        ...
                                        <div className="my-2">
                                          <div className="relative">
                                            <input
                                              {...field} id="weight" type="number" className={`block w-full rounded-md border-0 pr-12 px-2 py-1.5 pt-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6 ${
                                                form.errors.weight &&
                                                form.touched.weight
                                                  ? "ring-2 ring-red-600"
                                                  : ""

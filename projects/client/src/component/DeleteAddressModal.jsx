...
export default function DeleteAddressModal(props) {
  ...
  return (
    <>
      <button onClick={() => setOpen(true)} class="font-medium flex-none">
        <BackspaceIcon className="h-5 w-5 fill-white stroke-red-600"/>
      </button>
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Are you sure you want to delete your address? All of your data will be permanently removed
